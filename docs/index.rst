Welcome to IdNet6 (latest)
=============================================

.. image:: images/logo.png
   :align: center

IdNet6 is an OpenID Connect and OAuth 2.0 framework for ASP.NET Core.
...
.. warning:: 
   ...
   IdNet6 will be maintained with security updates until November 2022. 

...
The repo for this support is located `here <https://github.com/IdentityServer/IdNet6.AspNetIdentity/>`_ and the NuGet package is `here <https://www.nuget.org/packages/IdNet6.AspNetIdentity>`_.

...
using Xunit;
using ApiResource = IdNet6.Models.ApiResource;

namespace IdNet6.EntityFramework.UnitTests.Mappers
{
    public class ApiResourceMappersTests
    {
        ...
        {
            var entity = new IdNet6.EntityFramework.Entities.ApiResource
            {

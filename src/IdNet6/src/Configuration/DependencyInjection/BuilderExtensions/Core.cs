...
using IdNet6.Configuration.DependencyInjection;
using IdNet6.Endpoints;
using IdNet6.Events;
using IdNet6.Hosting;
using IdNet6.ResponseHandling;
using IdNet6.Services;
using IdNet6.Stores;
using IdNet6.Stores.Serialization;
...
using IdNet6.Hosting.FederatedSignOut;
using IdNet6.Services.Default;
...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    public static class IdentityServerBuilderExtensionsCore
    {
            ...
            where T : class, IEndpointHandler
        {
            ...
            builder.Services.AddSingleton(new IdNet6.Hosting.Endpoint(name, path, typeof(T)));

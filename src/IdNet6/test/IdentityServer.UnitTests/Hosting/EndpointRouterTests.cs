...
using Xunit;
using static IdNet6.Constants;

namespace IdentityServer.UnitTests.Hosting
{
    public class EndpointRouterTests
    {
        private Dictionary<string, IdNet6.Hosting.Endpoint> _pathMap;
        private List<IdNet6.Hosting.Endpoint> _endpoints;
        private IdentityServerOptions _options;
        private EndpointRouter _subject;

        public EndpointRouterTests()
        {
            _pathMap = new Dictionary<string, IdNet6.Hosting.Endpoint>();
            _endpoints = new List<IdNet6.Hosting.Endpoint>();
        ...
        {
            Action a = () => new IdNet6.Hosting.Endpoint("ep1", "ep1", typeof(MyEndpointHandler));
        ...
        {
            _endpoints.Add(new IdNet6.Hosting.Endpoint("ep1", "/ep1", typeof(MyEndpointHandler)));
            _endpoints.Add(new IdNet6.Hosting.Endpoint("ep2", "/ep2", typeof(MyOtherEndpointHandler)));
        ...
        {
            _endpoints.Add(new IdNet6.Hosting.Endpoint("ep1", "/ep1", typeof(MyEndpointHandler)));
            _endpoints.Add(new IdNet6.Hosting.Endpoint("ep1", "/ep1", typeof(MyOtherEndpointHandler)));
        ...
        {
            _endpoints.Add(new IdNet6.Hosting.Endpoint(EndpointNames.Authorize, "/ep1", typeof(MyEndpointHandler)));
            _endpoints.Add(new IdNet6.Hosting.Endpoint("ep2", "/ep2", typeof(MyOtherEndpointHandler)));

...
namespace IdentityServer.UnitTests.ResponseHandling.AuthorizeInteractionResponseGenerator
{
    public class AuthorizeInteractionResponseGeneratorTests
    {
        ...
        private IdNet6.ResponseHandling.AuthorizeInteractionResponseGenerator _subject;
        ...
        {
            _subject = new IdNet6.ResponseHandling.AuthorizeInteractionResponseGenerator(
                _clock,
